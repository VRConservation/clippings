...
- [Web — Using OpenCode in your browser](https://opencode.ai/docs/web/): Run OpenCode as a web application with `opencode web`, including ports, mDNS discovery, CORS, authentication, and terminal attach. Related: [[Software]]. Keywords: opencode, web, server, config, mDNS
